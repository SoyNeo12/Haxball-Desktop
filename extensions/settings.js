...
(function () {
    ...
    function modifySettingsDialog(doc) {
        ...
        var tabIcons = {
            ...
            'inputbtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M6 8h.01M10 8h.01M14 8h.01M18 8h.01M8 12h.01M12 12h.01M16 12h.01M6 16h12"/></svg>', tooltip: t('Controles'), order: 3 },
            'perfbtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>', tooltip: t('Desempenho'), order: 4 },
            'avatarbtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>', tooltip: t('Avatares'), order: 5 },
            'tokenbtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/></svg>', tooltip: t('Host Token'), order: 6 },
            'themebtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>', tooltip: t('Temas'), order: 7 },
            'multiauthbtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="9" cy="9" r="4"/><path d="M9 13c-4 0-6 2-6 5v1h12v-1c0-3-2-5-6-5"/><path d="M16 11h6m-3-3v6"/></svg>', tooltip: t('Multi-Auth'), order: 8 },
            'miscbtn': { icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-2 2 2 2 0 01-2-2v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83 0 2 2 0 010-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 01-2-2 2 2 0 012-2h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 010-2.83 2 2 0 012.83 0l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 012-2 2 2 0 012 2v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 0 2 2 0 010 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 012 2 2 2 0 01-2 2h-.09a1.65 1.65 0 00-1.51 1z"/></svg>', tooltip: t('Diversos'), order: 9 }
        };

        // Ordem customizada dos botões
        var tabOrder = ['soundbtn', 'videobtn', 'inputbtn', 'perfbtn', 'avatarbtn', 'tokenbtn', 'themebtn', 'multiauthbtn', 'miscbtn'];
        ...
        function createPerfTab(doc, tabs) {
            ...
            exportBtn.onmouseenter = function() { exportBtn.style.background = 'var(--theme-bg-hover)'; };
            exportBtn.onmouseleave = function() { exportBtn.style.background = 'var(--theme-bg-secondary)'; };
            exportBtn.onclick = function() {
                var code = generatePerfCode();
                navigator.clipboard.writeText(code).then(function() {
                    var originalText = exportBtn.innerHTML;
                    exportBtn.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>' + t('Copiado!');
            ...
            importBtn.onmouseenter = function() { importBtn.style.background = 'var(--theme-bg-hover)'; };
            importBtn.onmouseleave = function() { importBtn.style.background = 'var(--theme-bg-secondary)'; };
            importBtn.onclick = function() {
                var originalText = importBtn.innerHTML;
                navigator.clipboard.readText().then(function(code) {
                    code = code.trim();
                    if (!code) {
                        importBtn.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>' + t('Clipboard vazio');
                    ...
                    if (applyPerfCode(code)) {
                        importBtn.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>' + t('Aplicado! Recarregue');
                        ...
                        importBtn.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>' + t('Código inválido');
                        importBtn.style.borderColor = '#dc2626';
                        setTimeout(function() {
                            importBtn.innerHTML = originalText;
                            importBtn.style.borderColor = '';
                    ...
                    importBtn.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>' + t('Sem permissão');
                    importBtn.style.borderColor = '#dc2626';
                    setTimeout(function() {
                        importBtn.innerHTML = originalText;
                        importBtn.style.borderColor = '';
        ...
        function createMultiAuthTab(doc, tabs) {
            ...
            function updateHeader() {
                ...
                var found = authsList.find(function(a) { return a.key === current; });
            ...
            function renderAuthList() {
                ...
                auths.forEach(function(authObj, index) {
                    ...
                    if (!isActive) {
                        ...
                        useBtn.onmouseenter = function() { useBtn.style.background = '#2563eb'; };
                        useBtn.onmouseleave = function() { useBtn.style.background = '#3b82f6'; };
                    ...
                    removeBtn.onclick = function() {
                        var newAuths = auths.filter(function(_, i) { return i !== index; });
                        saveAuths(newAuths);
                        renderAuthList();
                        if (window.showToast) {
            ...
            addBtn.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>' + t('Adicionar');
            addBtn.onmouseenter = function() { addBtn.style.background = '#16a34a'; };
            addBtn.onmouseleave = function() { addBtn.style.background = '#22c55e'; };
            addBtn.onclick = function() {
                ...
                // Verifica duplicata
                var exists = auths.some(function(a) { return a.key === authKey; });
                if (exists) {
            ...
            saveCurrentBtn.onclick = function() {
                ...
                var auths = getStoredAuths();
                var exists = auths.some(function(a) { return a.key === currentAuth; });
                if (exists) {
