...
(function (pa) {
        ...
        constructor(a, b, c) {
            ...
            this.Ra.onicecandidate = function (f) {
                null == f.candidate
                    ? d(e.ig)
                    : ((f = f.candidate),
                      null != f.candidate && "" != f.candidate && (null != e.xg && e.xg(f), e.ig.push(f)));
            };
    ...
    class V {
            ...
            if (null != a.M) {
                ...
                for (g = a.K; f < g.length; ) {
                    ...
                    if (null != n) {
                        ...
                        var isLocalPlayer =
                            window._splitExtraEnabled &&
                            window._haxLocalPlayerId &&
                            player.Z === window._haxLocalPlayerId;
        ...
        xr(a) {
            ...
            b &&
                (120 != a.Ta &&
                    ((a = (a.Ta / 120) * 200), (this.c.fillStyle = "white"), this.c.fillRect(0.5 * -a, 100, a, 20)),
    ...
    class ac {
        ...
        Hi(a) {
            ...
            a.Rl = function (d) {
                ...
                9e3 > e - d.un ||
                    ((d.un = e), c.l.Ka.Hb("" + d.D + " " + (d.Td ? "has desynchronized" : "is back in sync")));
            };
            a.Wl = function (d, e, f) {
    ...
    class Za extends p {
        ...
        apply(a) {
            if (a.Pb(this.P)) {
                ...
                c = d.length;
                0 != c &&
                    (f == e ? 2 > c || (a.ag(b, d[0], u.ia), a.ag(b, d[1], u.Da)) : a.ag(b, d[0], f > e ? u.ia : u.Da));
            }
        }
        wa() {}
        xa() {}
