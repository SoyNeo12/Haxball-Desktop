...
(function (pa) {
  ...
  // Color Cache - evita criação de strings repetidas
  ...
  // Object Pool para vetores temporários
  const _vecPool = [];
  let _vecPoolIdx = 0;
  ...
  function _resetVecPool() {
    _vecPoolIdx = 0;
  }
  // Pre-computed constants
  const _TWO_PI = 2 * Math.PI;
  const _HALF_PI = Math.PI / 2;
  // Bitwise floor - mais rápido que Math.floor para coordenadas
  function _fastFloor(n) {
    return n | 0;
  }
  // Bitwise round - evita sub-pixel rendering
  function _fastRound(n) {
    return (n + 0.5) | 0;
  }
  // Path2D pré-compilado para círculos (evita recriar path a cada frame)
  const _circlePath = new Path2D();
  _circlePath.arc(0, 0, 1, 0, _TWO_PI, false);

  // Sprite Cache para círculos - drawImage() é MUITO mais rápido que arc()
  const _spriteCache = new Map();
  const _spriteCacheMaxSize = 64;
  const _spriteSize = 64; // tamanho base do sprite
  ...
  // Sprite para bola (branca com borda preta)
  ...
  class Sa {
    ...
    A(a) {
      ...
      for (b = this.H.length; a < b; ) {
        ...
        c = this.H[d];
        d += 1;
        for (e = this.H.length; d < e; ) ((f = this.H[d++]), 0 != (f.i & c.B) && 0 != (f.B & c.i) && c.wo(f));
        if (0 != c.ca) {
          d = 0;
          ...
          d = 0;
          for (e = this.X; d < e.length; ) ((f = e[d]), ++d, 0 != (f.i & c.B) && 0 != (f.B & c.i) && c.xo(f));
          d = 0;
              ...
              2097152 <= a
                ? (this.s.setUint8(b + 3, (a >> 21) | 128),
                  268435456 <= a
                    ...
                    : (this.s.setUint8(b + 3, this.s.getUint8(b + 3) & 127), (a = 4)))
  ...
  class kc {
    ...
    Zr(a) {
      a != this.Ck && ((this.Lq.className = a ? 'overtime on' : 'overtime'), (this.Ck = a));
    }
    fs(a) {
      a != this.Dk && ((this.f.className = a ? 'game-timer-view time-warn' : 'game-timer-view'), (this.Dk = a));
    }
  }
  class ib {
    constructor(a) {
  ...
  class nb {
    ...
    Zh(a) {
      let b = a.jb(),
        c;
      try {
        ((a = new J(new DataView(pako.inflateRaw(a.sb()).buffer), !1)), (c = new RTCIceCandidate(a.Jg())));
      } catch (d) {
        return;
      }
      this.sp(b, c);
  ...
  class ob {
    ...
    A(a, b) {
      ...
      null == a
        ? H.h(this.rb)
        : (this.zs(a), (this.Xf.disabled = !b || 0 == this.Rb), (this.df.disabled = !b || 0 == this.Rb));
    }
    zs(a) {
  ...
  class q {
    ...
    el(a) {
      ...
      let f = d.traits;
      a = d.ballPhysics;
      'disc0' != a && (null != a ? ((a = q.fl(a, this.rg())), (a.B |= 192), this.H.push(a)) : this.H.push(this.rg()));
    ...
    ro(a, b) {
      ...
      for (; c < d.length; ) {
        ...
        var e = h.$,
          ...
          g = b.x - a.x;
        let k = b.y - a.y;
        0 < -(e.y - a.y) * g + (e.x - a.x) * k == 0 < -(f.y - a.y) * g + (f.x - a.x) * k
          ? (e = !1)
          : ((g = f.x - e.x),
            (f = f.y - e.y),
    ...
    sg(a, b, c, d, e, f) {
      ...
      this.L.push(r);
      h = b;
      for (b = this.L.length; h < b; ) ((k = h++), (this.L[k].i = f), (this.L[k].B = g), (this.L[k].o = 0.1));
      b = this.X.length;
      this.X.push(l);
      this.X.push(t);
      this.X.push(z);
      h = b;
      for (b = this.X.length; h < b; ) ((k = h++), (this.X[k].i = f), (this.X[k].B = g), (this.X[k].o = 0.1));
      f = new xa();
      g = f.a;
      g.x = a;
      g.y = -c;
    ...
    static Rp(a, b) {
      ...
      null == a
        ? ((d = b[d]),
          ...
          null == d || null == e
            ? (c.fc = c.Ib = 100)
            : ((b = d.a), (d = e.a), (e = b.x - d.x), (b = b.y - d.y), (c.fc = c.Ib = Math.sqrt(e * e + b * b))))
        : a instanceof Array
    ...
    static Tp(a) {
      ...
      null != h && (b.hf = w.J(h, E));
      null != k && (b.ef = w.J(k, E));
      null != l && ((c = b.ra), (d = w.J(l[1], E)), (c.x = w.J(l[0], E)), (c.y = d));
      null != n && (b.B = q.Kc(n));
      null != r && (b.V = w.J(r, E));
      null != a && (b.ff = w.J(a, E));
      return b;
  ...
  class Xb {
    ...
    hk(a) {
      if (null != this.dd) {
        ...
        a = this.dd[this.zc];
        b != this.zc && (a.La.classList.toggle('selected', !0), this.dd[b].La.classList.toggle('selected', !1));
        a = a.La;
        b = a.offsetTop;
        a = b + a.offsetHeight;
      ...
      function b(y) {
        ...
        L.onclick = function () {
          ...
          qc.onmousedown = function (T) {
            ...
            null == tb.v(code) && (tb.Pa(code, y), m.j.Jd.ha(tb), Gc());
          };
        };
        return F;
      }
  ...
  class vb {
    ...
    A(a, b) {
      this.f.draggable = b;
      this.zb != a.zb && ((this.zb = a.zb), (this.Fg.textContent = '' + this.zb));
  ...
  class Yb {
    ...
    set(a) {
      this.value != a && ((this.value = a), (this.La.textContent = '' + this.value));
    }
  }
  class wb {
    constructor(a) {
      ...
      for (a = 2; 21 > a; )
        ((b = window.document.createElement('option')), (b.textContent = '' + a++), this.ri.appendChild(b));
  ...
  class Ba {
    constructor(a, b, c) {
      ...
      this.Ra.onicecandidate = function (f) {
        null == f.candidate
          ? d(e.ig)
          : ((f = f.candidate), null != f.candidate && '' != f.candidate && (null != e.xg && e.xg(f), e.ig.push(f)));
      };
  ...
  class rc {
    ...
    Rc() {
      ...
      var fpsVal = m.j.Rh.v();
      var fpsIntervals = [0, 33.333, 16.666, 13.333, 6.944, 4.166]; // None, 30, 60, 75, 144, 240
      var interval = fpsIntervals[fpsVal] || 0;
      (interval > 0 && interval > a - this.hd) ||
        ((this.hd = a), this.Bd++, this.Jm(m.j.Rd.v()), 0 < this.za.Pd || this.l.A(this.za));
    }
    Fa(a) {
      var b = m.j.Rd;
    ...
    Jm() {
      ...
      b.te = m.j.Mi.v();
      b.Wg = 35;
      1 == a ? (b.Ld = 610) : ((b.Ld = 0), (b.Ig = 1 + 0.25 * (a - 2)));
    }
  }
  class sc {
    constructor(a, b) {
    ...
    update() {
      ...
      0 >= this.qh && 0.05 > this.He && (window.clearInterval(this.uh), (this.uh = null), (this.He = 0));
  ...
  class za {
    ...
    Ur(a) {
      this.tl != a && ((this.tl = a), this.f.style.setProperty('--chat-opacity', '' + a));
    }
    Tr(a) {
      this.sl != a && ((this.sl = a), this.f.classList.toggle('chat-bg-full', a));
    }
    cs(a) {
      this.vl != a && ((this.vl = a), this.ib.f.classList.toggle('restricted', a));
    }
    A(a) {
      ...
      0 == b
        ? ((c.Ig = 1), (c.Ld = 0), (c.Wg = 0), (this.ib.gb.Dh = 0), (this.ib.f.style.paddingBottom = d + 'px'))
        : ((c.Wg = 35),
          1 == b ? (c.Ld = 610) : ((c.Ld = 0), (c.Ig = 1 + 0.25 * (b - 2))),
    ...
    ab(a, b) {
      ...
      za.Tq = a;
      null != a
        ? ((this.yf.style.display = 'flex'), this.yf.appendChild(a), (this.Xl = b))
    ...
    A(a, b, c, d) {
      ...
      for (c = 0; c < a.length; )
        ((e = a[c]),
          ...
          b.delete(e.Z));
      d = b.values();
      for (b = d.next(); !b.done; ) ((c = b.value), (b = d.next()), this.Fd.get(c).f.remove(), this.Fd.delete(c));
      d = 0;
  ...
  class cb {
    ...
    hl(a) {
      ...
      b = this.Lc.scrollTop + b - this.Lc.scrollHeight >= 0.5 * -b || !cb.Ep(this.Lc);
  ...
  class V {
    constructor(a) {
      ...
      this.resolutionMultiplier =
        typeof window._hxdQualityMultiplier !== 'undefined' ? window._hxdQualityMultiplier : 0.9;
    ...
    Bs() {
      if (null != this.na.parentElement) {
        ...
        if (this.na.width != c || this.na.height != a) ((this.na.width = c), (this.na.height = a));
      }
    }
    Rc(a, b) {
      _resetVecPool();
      ...
      if (null != a.M) {
        ...
        var e = c.va,
          ...
          h =
            0 != this.Ld
              ...
              : this.Ig * window.devicePixelRatio * this.te * this.resolutionMultiplier;
        ...
        for (g = a.K; f < g.length; ) {
          ...
          if (null != n) {
            ...
            // SPLIT EXTRAPOLATION: aplica offset apenas no jogador local
            var isLocalPlayer =
              window._splitExtraEnabled && window._haxLocalPlayerId && player.Z === window._haxLocalPlayerId;

            if (isLocalPlayer && n.G) {
              var myExtra = window._splitExtraMy || 0;
              var othersExtra = window._splitExtraOthers || 0;
              var extraDiff = (myExtra - othersExtra) * 0.06; // 0.06 = Ec

              if (extraDiff > 0.1) {
                // Cria cópia temporária com posição extrapolada
                var offsetX = 0,
                  offsetY = 0;
                var velX = n.G.x,
                  velY = n.G.y;
                var damping = n.Ea || 0.99;

                for (var ef = 0; ef < extraDiff; ef++) {
                  offsetX += velX;
                  offsetY += velY;
                  velX *= damping;
                  velY *= damping;
                ...
                var tempDisc = {
                  V: n.V,
                  a: { x: n.a.x + offsetX, y: n.a.y + offsetY },
                  S: n.S,
                  B: n.B,
                  G: n.G,
                  Ea: n.Ea
                };
                this.km(tempDisc, l, player.fa);
                continue;
              }
            }
        ...
        this.xr(c);
        0 >= c.Ta && m.j.Um.v() && (this.Cd.A(d), this.Cd.Rc(this.c));
        this.Ug.clear();
        this.tr(a);
      }
    }
    ...
    ys(a, b, c, d, e) {
      ...
      b = g;
      b == b ? ((b = f), (b = b == b)) : (b = !1);
      b && ((k = b = this.Ya), (e *= 0.04), (h = k.x), (k = k.y), (b.x = h + (g - h) * e), (b.y = k + (f - k) * e));
      this.Eo(c, d, a.T);
    }
    Eo(a, b, c) {
      a > 2 * c.bc
    ...
    xr(a) {
      ...
      this.Wr(b);
      b &&
        (120 != a.Ta && ((a = (a.Ta / 120) * 200), (this.c.fillStyle = 'white'), this.c.fillRect(0.5 * -a, 100, a, 20)),
        this.Cd.Nq.Cr(this.c));
    }
    Wr(a) {
      this.Xk != a && ((this.na.style.filter = a ? 'grayscale(70%)' : ''), (this.Xk = a));
    }
    um(a, b, c, d, e, f) {
      d = b + d;
      e = c + e;
    ...
    km(a, b, playerTeam) {
      ...
      if (!m.j.Km.v()) {
        b = null;
        // Usa cores padrão do time quando avatar desabilitado
      ...
      // OTIMIZAÇÃO: usa sprites pré-renderizados + drawImage (muito mais rápido que arc)
      // Também elimina save/restore usando cálculos diretos
      var radius = a.V;
      var posX = a.a.x;
      var posY = a.a.y;
      var size = radius * 2;
      ...
      if (null != b) {
        ...
        // Sem avatar - verifica se usa sprite cache (baixa qualidade) ou arc (alta qualidade)
        if (m.j.Ym.v()) {
          // Baixa qualidade - usa sprite cache (mais rápido mas pixelado)
          var fillColor = -1 != (a.S | 0) ? V.nc(a.S) : null;
          var sprite = _getCircleSprite(fillColor, 'black');
          this.c.drawImage(sprite, posX - radius, posY - radius, size, size);
        } else {
          // Alta qualidade - usa arc (mais lento mas suave)
          this.c.beginPath();
          this.c.arc(posX, posY, radius, 0, _TWO_PI, false);
          if (-1 != (a.S | 0)) {
    ...
    vr(a, b) {
      if (!(0 > a.S)) {
        ...
        if (m.j.Wm.v()) {
          ...
          if (
            maxX < this.cullCamX - this.cullHalfW ||
    ...
    zr(a) {
      if (a.bb) {
        ...
        if (m.j.Xm.v() || 0 != 0 * a.vb) (this.c.moveTo(b.x, b.y), this.c.lineTo(c.x, c.y));
        else {
          a = a.fe;
          let d = b.x - a.x;
          b = b.y - a.y;
    ...
    ur(a, b, c) {
      var d = a.M;
      if (null != d)
        for (d = d.va.H[0], this.Ik(d.a, d.S, b, c), d = 0, a = a.K; d < a.length; ) {
          let e = a[d];
          ++d;
    ...
    qr(a) {
      ...
      if (!(1 > b.length)) {
        ...
        for (var c = -32, d = 64 / b.length, e = 0; e < b.length; )
          ((this.Kb.fillStyle = V.nc(b[e++])), this.Kb.fillRect(c, -32, d + 4, 64), (c += d));
        this.Kb.restore();
        if (m.j.Km.v()) {
      ...
      switch (c) {
        ...
        case 'object':
          ...
          if (a instanceof Array) {
            ...
            b += '\t';
            e = 0;
            for (f = a.length; e < f; ) ((d = e++), (c += (0 < d ? ',' : '') + w.Pe(a[d], b)));
            return (c += ']');
          }
          try {
            e = a.toString;
  ...
  class I {
    ...
    qe() {
      if (0 == 0 * this.vb) {
        ...
        0 >= this.vb && ((a = c = this.Sg), (c.x = -a.x), (c.y = -a.y), (a = c = this.Tg), (c.x = -a.x), (c.y = -a.y));
      } else
        ((a = this.$.a),
          (b = this.ea.a),
          (c = a.x - b.x),
  ...
  class xc {
    constructor() {
      ...
      this.Ym = b('low_quality_circles', !0); // Círculos de baixa qualidade (sprite cache) - ativo por padrão
  ...
  class bc {
    ...
    xf(a) {
      ...
      switch (b) {
        case 'avatar':
          2 == a.length && (window._haxGifActive || this.da('Avatar set'), this.Em(a[1]));
          break;
        case 'checksum':
          var d = this.za.U.T;
          a = d.D;
          d.cf()
            ...
            : ((d = aa.hh(d.lk(), 8)), this.da('Stadium: "' + a + '" (checksum: ' + d + ')'));
          break;
        case 'clear_avatar':
          this.Em(null);
        ...
        case 'extrapolation':
          2 == a.length
            ? ((a = R.parseInt(a[1])),
              null != a && -200 <= a && 1e3 >= a
                ? (m.j.Ad.ha(a), this.za.Fm(a), this.da('Extrapolation set to ' + a + ' msec'))
                : this.da('Extrapolation must be a value between -200 and 1000 milliseconds'))
        ...
        case 'handicap':
          2 == a.length
            ? ((a = R.parseInt(a[1])),
              null != a && 0 <= a && 300 >= a
                ? (this.za.Vr(a), this.da('Ping handicap set to ' + a + ' msec'))
                : this.da('Ping handicap must be a value between 0 and 300 milliseconds'))
  ...
  class J {
    ...
    Bb() {
      let a = this.a,
        ...
        c,
        d = 0;
      do ((c = this.s.getUint8(a + b)), 5 > b && (d |= ((c & 127) << (7 * b)) >>> 0), ++b);
      while (0 != (c & 128));
      this.a += b;
      return d | 0;
    }
    re(a) {
      let b = this.a,
        c,
        d = '';
      for (a = b + a; b < a; ) ((c = J.Po(this.s, b)), (b += c.length), (d += String.fromCodePoint(c.char)));
  ...
  class B {
    ...
    static Uo() {
      ...
      b.rq = function (c) {
        ...
        var hostToken = null;
        try {
          hostToken = localStorage.getItem('haxball_host_token') || null;
        } catch (e) {}
        let k = new cc({
          iceServers: m.kg,
          Aj: m.Se + 'api/host',
    ...
    static Vo(a) {
      try {
        ...
        let c = v.Mb(b).Fb();
        if (c instanceof ec)
          ((a = new ba('Incompatible replay version', 'The replay file is of a different version', [
            'Open player',
            'Cancel'
          ])),
            C.Na(a.f),
  ...
  class Rb {
    constructor(a) {
      ...
      b = function () {
        var e = c.mr - c.ns();
        0 >= e ? c.la() : (window.clearTimeout(c.Zm), (e = window.setTimeout(b, e + 1e3)), (c.Zm = e));
      };
      b();
      ...
      for (; a < d.length; ) {
        ...
        e.onmessage = function (f) {
          c.Ed && ((c.Wm = window.performance.now()), null != c.zg && c.zg(f.data));
        };
        e.onclose = function () {
          c.la();
        };
    ...
    la() {
      ...
      this.Ed && ((this.Ed = !1), this.Ra.close(), null != this.tf && this.tf());
    }
  }
  class H {
    static h(a) {
  ...
  class jc {
    ...
    bt(a, b) {
      ...
      if ((c = this.match(0 > c ? O.substr(a, b, null) : O.substr(a, b, c)))) ((this.r.ph = a), (this.r.pc.index += b));
      return c;
    }
  }
  class Kc {
  ...
  class Ab {
    ...
    A(a, b) {
      ...
      b = null == b ? !1 : b.fb;
      this.Ak != b && ((this.f.className = 'room-view' + (b ? ' admin' : '')), (this.Ak = b));
      var c = !b || null != a.M;
      this.Lf.disabled = c;
      this.Ef.disabled = c;
      this.Qm.disabled = c;
  ...
  class ua {
    ...
    Ws() {
      let a = ra.Cc,
        b = this.Cn;
      this.Cc != a && (null == b && (this.Cn = b = new ua()), (this.Cc = a), ua.Ns(b, this));
      return b;
    }
    static Ns(a, b) {
      a.fb = b.fb;
  ...
  class Qa {
    constructor(a) {
      ...
      0 != c && (a.Fm(m.j.Ad.v()), this.l.Ka.Hb('Extrapolation set to ' + c + ' msec'));
    }
    ls() {
    ...
    Rc() {
      ...
      var interval = fpsIntervals[fpsVal] || 0;
      (interval > 0 && interval > a - this.hd) ||
        ((this.hd = a), this.Bd++, (a = this.za.U.oa(this.za.xc)), null != a && (this.Ni = a.fb), this.l.A(this.za));
    }
    oq(a) {
      let b = this;
      this.dg.xf(a) ||
  ...
  class fc {
    ...
    add(a) {
      ...
      b >= this.et ? ((b = this.cb[c]), (this.Yd -= b.weight), this.cb.splice(c, 1)) : (b = new zc());
      b.value = a;
      b.weight = 1;
      b.index = 0;
      this.Yd += b.weight;
    ...
    mh() {
      ...
      let b = this.cb[0].weight,
        c = 0;
      for (; c < this.cb.length - 1 && !(b >= a); ) (++c, (b += this.cb[c].weight));
  ...
  class ea {
    ...
    Cr(a) {
      ...
      for (; c < d.length; ) {
        let e = d[c];
        ++c;
        a.drawImage(e, 0.5 * -e.width, 35 * -(this.kf.length - 1) + 70 * b - 0.5 * e.height);
        ++b;
      }
      a.imageSmoothingEnabled = !1;
    }
  ...
  class Y {
    ...
    A(a) {
      if (0 < this.Ta) 120 > this.Ta && this.Ta--;
        ...
        for (var c = 0; c < b.length; ) {
          ...
          if (null != d.I) {
            ...
            if (d.Yb && 0 >= d.Zc && 0 <= d.Bc) {
              ...
              f && (null != this.Sa.zi && this.Sa.zi(d), (d.Yb = !1), (d.Zc = this.Sa.Gd), (d.Bc -= this.Sa.gd));
            }
            f = d.W;
            h = g = 0;
            0 != (f & 1) && --h;
        ...
        for (g = d.length; e < g; )
          ((f = e++),
            (h = d[f]),
            0 != (h.B & 128) && ((Y.yk[c] = f), (f = Y.ul[c]), (h = h.a), (f.x = h.x), (f.y = h.y), ++c));
        this.va.A(a);
        if (0 == this.Cb) {
          for (a = 0; a < b.length; ) ((c = b[a]), ++a, null != c.I && (c.I.i = 39 | this.ke.Jp));
          b = this.va.H[0].G;
          0 < b.x * b.x + b.y * b.y && (this.Cb = 1);
        } else if (1 == this.Cb) {
          this.Nc += 0.016666666666666666;
          for (a = 0; a < b.length; ) ((d = b[a]), ++a, null != d.I && (d.I.i = 39));
          d = u.Oa;
          b = this.va.H;
        ...
        else if (3 == this.Cb && (this.yc--, 0 >= this.yc && ((b = this.Sa), null != b.M))) {
          b.M = null;
          a = 0;
          for (c = b.K; a < c.length; ) ((d = c[a]), ++a, (d.I = null), (d.Nb = 0));
          null != b.Kf && b.Kf(null);
        }
      }
    }
      ...
      for (c = 0; c < a.length; )
        if (((d = a[c]), ++c, this.Wk(d), (e = d.fa), e != u.Oa)) {
          ...
          var g = this.T,
            ...
            k = e == u.ia ? g.Md : g.vd;
          0 == k.length
            ? ((k = (h + 1) >> 1), 0 == (h & 1) && (k = -k), (g = g.mc * e.Oh), (h = 55 * k))
            : (h >= k.length && (h = k.length - 1), (h = k[h]), (g = h.x), (h = h.y));
          f.x = g;
          f.y = h;
          b[e.ba]++;
          d.Nb = b[e.ba];
    ...
    uc() {
      let a = ra.Cc,
        b = this.ic;
      this.jc != a && (null == b && (this.ic = b = new Y()), (this.jc = a), Y.zd(b, this));
      return b;
    }
    static zd(a, b) {
      a.Sa = b.Sa.uc();
  ...
  class qa {
    ...
    xo(a) {
      ...
      g >= this.V ||
        ...
        (g = this.G),
        (g = b * g.x + d * g.y),
        0 > g && ((g *= this.o * a.o + 1), (c = a = this.G), (a.x = c.x - b * g), (a.y = c.y - d * g)));
    }
    uc() {
      let a = ra.Cc,
        b = this.ic;
      this.jc != a && (null == b && (this.ic = b = new qa()), (this.jc = a), qa.zd(b, this));
      return b;
    }
    static zd(a, b) {
      a.V = b.V;
  ...
  class ac {
    ...
    Hi(a) {
      ...
      a.Rl = function (d) {
        ...
        9e3 > e - d.un || ((d.un = e), c.l.Ka.Hb('' + d.D + ' ' + (d.Td ? 'has desynchronized' : 'is back in sync')));
      };
      a.Wl = function (d, e, f) {
  ...
  class tc {
    ...
    A(a) {
      0 < this.eb.length && (this.Wc += a) > this.eb[0].fp() && ((this.Wc = 0), this.eb.shift());
    }
    Rc(a) {
  ...
  class dc extends oa {
    ...
    cm() {
      ...
      0 < a.s.byteLength - a.a
        ? ((a = this.Sc.Bb()), (this.vg += a), (a = this.Sc.Sb()), (this.ug = p.th(this.Sc)), (this.ug.P = a))
        : (this.ug = null);
    }
    mp() {
    ...
    A() {
      ...
      this.ii = a;
      0 < this.Pd
        ? ((this.Ub += 1e4), this.Ub > this.Pd && ((this.Ub = this.Pd), (this.Pd = -1)))
        : (this.Ub += b * this.Ol);
      a = this.Bf * this.vh;
      this.Ub > a && (this.Ub = a);
      b = this.Ub * this.Ec;
      ...
      for (this.Mk = b - a; this.Y < a; ) {
        for (; null != this.ug && this.vg == this.Y; )
          ((b = this.ug), b.apply(this.U), null != this.hc && this.hc(b), this.cm());
        this.Y++;
        this.U.A(1);
      }
    }
  ...
  class Za extends p {
    ...
    apply(a) {
      if (a.Pb(this.P)) {
        ...
        c = d.length;
        0 != c && (f == e ? 2 > c || (a.ag(b, d[0], u.ia), a.ag(b, d[1], u.Da)) : a.ag(b, d[0], f > e ? u.ia : u.Da));
      }
    }
    wa() {}
    xa() {}
  ...
  class Ha extends p {
    ...
    apply(a) {
      if (a.Pb(this.P)) {
        var b = a.oa(this.P),
          c = a.oa(this.Ud);
        null != c && 0 != c.Z && c.fb != this.jh && ((c.fb = this.jh), null != a.yi && a.yi(b, c));
      }
    }
    wa(a) {
      a.R(this.Ud);
  ...
  class mb extends p {
    ...
    wa(a) {
      ...
      e = 0;
      for (f = this.Yc; e < f.length; ) ((g = f[e]), ++e, null != g && ((c |= d), a.R(g)), (d <<= 1));
      d = a.a;
      a.a = b;
      a.Xb(c);
      a.a = d;
    ...
    xa(a) {
      ...
      this.Yc = [];
      for (c = 0; 3 > c; ) ((d = c++), (this.Yc[d] = null), 0 != (b & 1) && (this.Yc[d] = a.N()), (b >>>= 1));
    }
  }
  class La extends p {
    constructor() {
